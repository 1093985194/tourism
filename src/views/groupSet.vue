          ...
          <div>
            <div style="float:left;width: 40%;margin-right: 20px">
              ...
              <div class="input-group igS">
                <span class="input-group-addon">团体</span>
                <input type="text" class="form-control" placeholder="请输入团体出行人数" aria-describedby="basic-addon1">
              </div>
              <div class="input-group igS">
                <span class="input-group-addon">成人</span>
...
<script>
  export default {
    ...
    created () {
      ...
      this.groups = this.$route.params.group
    },
    mounted () {
      this.hotelConfig()
      this.goodsConfig()
